...
module ApiErrorCodes
  ...
  # Resource-specific not-found codes (used by controllers/services and mapped
  # to :not_found in #status_for). Defined explicitly so referencing them never
  # raises NameError (which would turn a structured 404 into an opaque 500).
  ACCOUNT_NOT_FOUND = 'ACCOUNT_NOT_FOUND'
  AGENT_NOT_FOUND = 'AGENT_NOT_FOUND'
  AGENT_BOT_NOT_FOUND = 'AGENT_BOT_NOT_FOUND'
  AI_AGENT_NOT_FOUND = 'AI_AGENT_NOT_FOUND'
  AI_CUSTOM_TOOL_NOT_FOUND = 'AI_CUSTOM_TOOL_NOT_FOUND'
  ...
  PIPELINE_ITEM_NOT_FOUND = 'PIPELINE_ITEM_NOT_FOUND'
  ...
  # Template bundles (export/import)
  TEMPLATE_INVALID_BUNDLE = 'TEMPLATE_INVALID_BUNDLE'
  TEMPLATE_UNSUPPORTED_SCHEMA = 'TEMPLATE_UNSUPPORTED_SCHEMA'
  TEMPLATE_FILE_TOO_LARGE = 'TEMPLATE_FILE_TOO_LARGE'
  TEMPLATE_IMPORT_FAILED = 'TEMPLATE_IMPORT_FAILED'
  TEMPLATE_EXPORT_FAILED = 'TEMPLATE_EXPORT_FAILED'
